...
insert into coordenador_ac(nome_admin, login, senha) values ('teste', 'teste.teste', '1234')

insert into aluno(cpf, nome, senha, email, matricula, ano_ingresso, permissao, coordenador_ac_id_admin) values ('12345678901', 'teste_aluno', 'teste', 'fulano@gamil.com', '12345678', '2017', 'true', '1')
