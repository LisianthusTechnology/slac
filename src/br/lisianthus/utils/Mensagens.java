...
public class Mensagens {
	...
	/*AÇÃO NÃO IMPLEMENTADA*/
	public final String ATIVIDADE = "Atividade alterada com sucesso!";
	public final String ATIVIDADEEX = "Atividade excluída com sucesso!";
	public final String ALTERASTATUS = "MUDANÇA DO STATUS realizada com sucesso!";
	public final String ERRO1 = "Já existe um registro com este id!";
	public final String ERRO2 = "não foi definido, objeto inválido!"; //quando o objeto nao foi escolhido
	public final String ERRO3 = "Campo NOME DO EVENTO é de preenchimento obrigatório!";
	...
	/*VALIDÇÃO DE CPF*/
	public final String ERRO9 = "O CPF já está cadastrado. Aguarde a validação ou entre em contato com o coordenador!";
